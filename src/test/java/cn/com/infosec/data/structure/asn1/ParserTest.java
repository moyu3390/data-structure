...
//            while ((token = p.next(in)) != null) {
//                numTokens++;
//                Utils.consume(token.getValueStream(false)); //need to consume the value bytes
//            }
//            assertEquals(1, numTokens);
//        }
//        finally {
...
//        byte[] raw = Utils.bytesOf(0x24,0x80,0x04,0x01,0x01,0x04,0x01,0x02,0x00,0x00);
//
//        Parser p = new ParserFactory().newHeaderParser();
...
//        byte[] result = Utils.consume(chunkIn);
//        h.encodeTo(baos);
//        baos.write(result);
...
//        byte[] result = Utils.consume(chunkIn);
//        baos.write(result);
//        Assert.assertArrayEquals(Utils.bytesOf(0x01,0x02), baos.toByteArray());
//    }
//}
