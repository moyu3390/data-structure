...
//import cn.com.infosec.data.structure.asn1.bean.InfiniteLengthBitString;
...
//import cn.com.infosec.data.structure.asn1.bean.InfiniteLengthOctetString;
//import cn.com.infosec.data.structure.asn1.bean.InfiniteLengthStreamingValue;
//import cn.com.infosec.data.structure.asn1.bean.InfiniteLengthListValue;
//import cn.com.infosec.data.structure.asn1.bean.PrimitiveValue;
//import cn.com.infosec.data.structure.asn1.bean.Sequence;
//import org.junit.*;
//
...
//        PrimitiveValue val = new PrimitiveValue(Tags.INTEGER, Utils.bytesOf(0x01,0x00));
//        Header h = val.getHeader();
//        assertEquals(Tags.INTEGER, h.getTag());
//        Assert.assertEquals(TagClass.UNIVERSAL, h.getTagClass());
...
//        byte[] expected = Utils.bytesOf(0x02,0x02,0x01,0x00);
...
//           add(new PrimitiveValue(Tags.OCTET_STRING, Utils.bytesOf(0x01)));
//           add(new PrimitiveValue(Tags.OCTET_STRING, Utils.bytesOf(0x02)));
//        }};
...
//        byte[] result = baos.toByteArray();
//        byte[] expected = Utils.bytesOf(0x30,0x06,0x04,0x01,0x01,0x04,0x01,0x02);
//        assertArrayEquals(expected, result);
//    }
//
//    @Test
//    public void complexLength() {
//        PrimitiveValue val = new PrimitiveValue(Tags.OCTET_STRING, Utils.byteTimes(0x00, 1000));
//        Header h = val.getHeader();
...
//        h.encodeTo(baos);
//        byte[] result = baos.toByteArray();
//        byte[] expected = Utils.bytesOf(0x04,0x82,0x03,0xe8);
//        assertArrayEquals(expected, result);
//    }
//
//    @Test
...
//        for (int i=0; i < 128; i++) {
//            PrimitiveValue val = new PrimitiveValue(Tags.OCTET_STRING, Utils.byteTimes(0x00, i));
//            Header h = val.getHeader();
//            assertEquals(Tags.OCTET_STRING, h.getTag());
//            assertEquals(TagClass.UNIVERSAL, h.getTagClass());
//            assertFalse(h.isConstructed());
...
//            assertEquals(2, h.getHeaderLength());
//        }
//        PrimitiveValue val = new PrimitiveValue(Tags.OCTET_STRING, Utils.byteTimes(0x00, 128));
//        Header h = val.getHeader();
//        assertEquals(Tags.OCTET_STRING, h.getTag());
//        assertEquals(TagClass.UNIVERSAL, h.getTagClass());
//        assertFalse(h.isConstructed());
...
//        h.encodeTo(baos);
//        byte[] result = baos.toByteArray();
//        byte[] expected = Utils.bytesOf(0x04,0x81,0x80);
//        assertArrayEquals(expected, result);
//    }
//
//    @Test
//    public void complexTagSingleOctet() {
//        PrimitiveValue val = new PrimitiveValue(42, TagClass.PRIVATE, Utils.bytesOf(0x00));
//        Header h = val.getHeader();
...
//        h.encodeTo(baos);
//        byte[] result = baos.toByteArray();
//        byte[] expected = Utils.bytesOf(0xdf,0x2a,0x01);
//        assertArrayEquals(expected, result);
//    }
//
//    @Test
//    public void complexTagTwoOctets() {
//        PrimitiveValue val = new PrimitiveValue(300, TagClass.APPLICATION, Utils.bytesOf(0x00));
//        Header h = val.getHeader();
...
//        h.encodeTo(baos);
//        byte[] result = baos.toByteArray();
//        byte[] expected = Utils.bytesOf(0x5f,0x82,0x2c,0x01);
//        assertArrayEquals(expected, result);
//    }
//
//    @Test
...
//        for (int i=0; i <= 30; i++) {
//            PrimitiveValue val = new PrimitiveValue(i, Utils.bytesOf(0x00));
//            Header h = val.getHeader();
...
//            assertEquals(2, h.getHeaderLength());
//        }
//        PrimitiveValue val = new PrimitiveValue(31, TagClass.APPLICATION, Utils.bytesOf(0x00));
//        Header h = val.getHeader();
...
//        h.encodeTo(baos);
//        byte[] result = baos.toByteArray();
//        byte[] expected = Utils.bytesOf(0x5f,0x1f,0x01);
//        assertArrayEquals(expected, result);
//    }
//
//    @Test
...
//        Asn1Serializer.serialize(val, baos);
//        byte[] result = baos.toByteArray();
//        byte[] expected = Utils.bytesOf(0x24,0x80,0x04,0x01,0x01,0x04,0x01,0x02,0x00,0x00);
//        assertArrayEquals(expected, result);
//    }
//
//    @Test
...
//        byte[] value = Utils.byteTimes(0x01, InfiniteLengthStreamingValue.DEFAULT_CHUNK_SIZE * 2 + 1);
//
//        InfiniteLengthStreamingValue val = clazz.getConstructor(InputStream.class)
//                                                .newInstance(new ByteArrayInputStream(value));
//
//        streamingChunked(val, tag, InfiniteLengthStreamingValue.DEFAULT_CHUNK_SIZE, Utils.bytesOf(0x82,0x20,0x00));
//    }
//
...
//        byte[] value = Utils.byteTimes(0x01, chunkSize * 2 + 1);
//
...
//
//        streamingChunked(val, tag, chunkSize, Utils.bytesOf(0x2a));
//    }
//
...
//        baos.write(Utils.bytesOf(tag | 0x20,0x80));
//
//        for(int i=0; i<2; i++) {
//          baos.write(Utils.bytesOf(tag));
//          baos.write(lengthEncoding);
//          baos.write(Utils.byteTimes(0x01, chunkSize));
//        }
//
//        baos.write(Utils.bytesOf(tag,0x01,0x01,0x00,0x00));
